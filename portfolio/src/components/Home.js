        ...
        <div className="container mx-auto px-4 lg:px-60 flex flex-col-reverse lg:flex-row justify-between items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start gap-3 mt-6">
              ...
              <button className="font-medium bg-blue-500 text-white py-2 px-4 rounded hover:bg-white hover:text-black transition duration-300"><a href="https://drive.google.com/file/d/1oD0S-tc50y0gpssp86BvkVL3vw3hxS4L/view?usp=sharing" target="_blank">Resume</a></button>
            </div>
          </div>
